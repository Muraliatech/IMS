...
const Inventory = () => {
  ...
  const { data, loading, error } = useFetch<FetchResponse>("http://localhost:5000/api/manager/inventory");

 
  const inventory: InventoryProp[] = Array.isArray(data?.inventory) ? data.inventory : [];
  ...
  if (error) return <p className="text-center text-red-500">Error loading inventory</p>;
                          ...
                          {inventory.map((item) => (
                            ...
                            >
                              ...
                              <div className="mt-4">
                                ...
                                <p className="text-gray-700">
                                  <span className="font-medium">Reorder Level:</span> {item.reorderLevel}
                                </p>
                                <p className="text-gray-700">
