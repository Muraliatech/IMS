        ...
        <div className="bg-slate-50 w-96 h-3/4 rounded-xl  p-9 shadow-2xl  flex flex-col justify-evenly items-center">
          ...
          <div className="w-full mt-4 flex justify-center">
            <button
              ...
              className="bg-blue-600 text-white px-10 py-2 rounded hover:bg-blue-800 font-sans"
            >
              Submit
            </button>
          </div>
          <div className="mt-4 text-sm">
            Already a member?{" "}
            <a onClick={handleSignin} className="text-blue-600 hover:underline cursor-pointer">
              Sign in
            </a>
          </div>
